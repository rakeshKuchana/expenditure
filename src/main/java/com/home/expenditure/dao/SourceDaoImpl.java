...
public class SourceDaoImpl implements SourceDao {
	...
	public void save(Source source) {
		...
		jdbcTemplate.update(sql,
				new Object[] { UUID.randomUUID().toString(), source.getSourceName(), source.getSourceAddress() });
	...
	public void delete(String sourceId) {
		...
		jdbcTemplate.update(sql, new Object[] { sourceId });
	...
	public void update(Source source) {
		...
		String sql = "update source set source_name = ?, source_address = ? where source_id = ? ";
		
		jdbcTemplate.update(sql, new Object[] {source.getSourceName(), source.getSourceAddress(), source.getSourceId()});
